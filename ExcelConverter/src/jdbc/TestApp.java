...
public class TestApp {
	...
	public static void main(String[] args) throws IOException {
		...
		for (SheetLine sl : l4) {
			...
			sl.setUnp(100000000 + rand.nextInt(89999999));
			sl.setOkpo(100000000000l + rand.nextInt(99999999));
			sl.setAccount(2000000000000l + rand.nextInt(99999999));
		...
		l1.setUnp(101010100);
		l1.setOkpo(202020202000l);
		l1.setAccount(3030303030000l);
		l1.setNets(false);
		l.add(l1);
